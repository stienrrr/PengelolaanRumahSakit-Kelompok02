@extends('cms.layout.main-cms', ['title' => 'Add Users Admin'])

@section('content')
	<div class="main-content">
		<!--breadcrumb-->
		<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
			<div class="h4">Add Users Admin</div>
		</div>
		<!--end breadcrumb-->
		...
		<div class="col-8 col-xl-8 mx-auto">
			<div class="card">
				<div class="card-body p-4">
					<form class="row g-3" action="{{ route('users.admin.store') }}" method="POST">
						@csrf
						<div class="col-md-6">
						...
						<div class="col-md-12">
							<div class="d-md-flex d-grid align-items-center gap-3">
								...
								<a href="{{ route('users.admin') }}" class="btn btn-secondary px-4">Back</a>
							</div>
						</div>
					</form>
				</div>
